    ...
    <section className="bg-black py-20 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
            O design mais refinado que já criamos. Titânio de grau aeroespacial. Chip 18 Pro.
          </p>
        </div>
    
      <div className="flex flex-col md:flex-row justify-center items-center mb-16 gap-4">
        <button type="button" className="bg-blue-600 hover:bg-blue-700 px-8 py-4 rounded-full text-white text-lg font-medium transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-500/50 cursor-pointer">Compre Agora</button>
        <button type="button" className="border-2 border-white rounded-full hover:bg-white hover:text-black text-white px-8 py-4 text-lg font-medium transition-all duration-300 hover:scale-105 shadow-lg cursor-pointer">Saiba Mais</button>
      </div>
